...
import { challengeRequestSchema } from "@workspace/navis-core/lib/auth/core";
...
import { AuthenticationError, createAuthenticationChallenge } from "@workspace/navis-core/lib/auth/server";
