...
import { agents, executionIntents, marketLaunches } from "@workspace/navis-core/lib/db/schema";
...
export async function POST(request: NextRequest) {
  ...
  const quota = await requireWalletQuota(session, "meteora.pool.prepare");
