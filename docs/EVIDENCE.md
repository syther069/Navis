...
| Item                        | Value                                                                                                                                                                                                                                           |
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Final application commit    | PENDING_CODE_COMMIT (GitHub `main`); the docs-only follow-up that records the public smoke against it is PENDING_DOCS_COMMIT                                                                                                                    |
...
| Deployed commit after push  | PENDING_DEPLOYED_COMMIT                                                                                                                                                                                                                         |
| Public judge smoke          | PENDING_PUBLIC_SMOKE                                                                                                                                                                                                                            |
...
| Screenshots                 | `docs/evidence/final-agent-run-verdict.png`, `final-agent-run-receipt-hash.png`, `final-agent-run-full.png`, `final-proof-page.png`, `final-markets-launch.png`, `final-landing.png` (captured with `scripts/capture-evidence-screenshots.mjs`) |
...
`GET https://navis-gilt.vercel.app/api/health` on 2026-09-20 returned HTTP 200 with `mode=demo`, `cluster=devnet` and these services: `database` not configured, `authenticationOrigin` not configured, `solanaRpc` configured (public devnet endpoint, read-only slot probe), `walletSessions` not configured, `clawpump` not configured, `meteora` configured (SDK reads only), `prestocks` configured, `ai` configured (deterministic demo provider). No secret values are returned.
