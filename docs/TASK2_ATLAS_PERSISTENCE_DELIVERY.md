...
Status: application code complete and tested; the production check section at
the end is filled in by the docs commit that follows the deployment.
...
Pending; recorded by the docs commit after deployment.
