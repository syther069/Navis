...
| INT-04 | Execute and record launch  | Submit one guarded launch and persist the real result.                                                | launch service, `MarketLaunch` repo   | Mint, tx hash, payout wallet, pair metadata, and request ID are verified and stored. | P0       | INT-03, funded agent/wallet |
...
| MET-03 | Build config/pool transaction flow | Prepare, decode, simulate, sign, confirm, and persist.                              | Meteora service/API/UI                | A real address/signature is shown only after confirmation.                 | P0       | MET-02, SOL-02, funded wallet         |
...
| SUB-02 | Prepare judge script/video | Tell one concise end-to-end story with proof.                                        | `docs/DEMO_SCRIPT.md`  | 3–5 minute rehearsal fits and every claim is verifiable.                  | P0       | TST-03             |
